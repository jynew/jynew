...
namespace Animancer
{
    ...
    partial class AnimancerState
    {
        ...
        /// </summary>
        private EventDispatcher _EventRunner;
        ...
        /// <see cref="OnStartFade"/> (unless <see cref="AnimancerState.AutomaticallyClearEvents"/> is disabled).
        /// <para></para>
        ...
        /// <see href="https://kybernetik.com.au/animancer/docs/manual/events/animancer#clear-automatically">Clear Automatically</see>
        ...
        /// <summary>
        /// The capacity of the internal list in the <see cref="ObjectPool{T}"/> for <see cref="EventDispatcher"/>.
        /// </summary>
        public static int EventPoolCapacity
        {
            get => ObjectPool<EventDispatcher>.Capacity;
            set => ObjectPool<EventDispatcher>.Capacity = value;
        }

        /************************************************************************************************************************/

        /// <summary>
        /// The number of spare items in the <see cref="ObjectPool{T}"/> for <see cref="EventDispatcher"/>.
        /// </summary>
        public static int EventPoolCount
        {
            get => ObjectPool<EventDispatcher>.Count;
            set => ObjectPool<EventDispatcher>.Count = value;
        }
        ...
        /// </summary>
        public static void SetMinEventPoolCount(int count) => ObjectPool<EventDispatcher>.SetMinCount(count);
        ...
        /// <summary>
        /// An <see cref="IUpdatable"/> which manages the triggering of
        /// <see href="https://kybernetik.com.au/animancer/docs/manual/events/animancer">Animancer Events</see>.
        /// </summary>
        private sealed class EventDispatcher : Key, IUpdatable
        {
            /************************************************************************************************************************/
            #region Pooling
            /************************************************************************************************************************/
            ...
            /// </summary>
            public static void TryClear(EventDispatcher events)
            {
                if (events != null)
                    events.Events = null;
            }
