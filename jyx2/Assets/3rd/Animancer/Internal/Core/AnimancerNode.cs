...
namespace Animancer
{
    ...
    public abstract class AnimancerNode : Key, IEnumerable<AnimancerState>, IEnumerator, IPlayableWrapper
    {
        ...
        public string GetDescription(int maxChildDepth = 10, string separator = "\n")
        {
            var text = ObjectPool.AcquireStringBuilder();
            AppendDescription(text, maxChildDepth, separator);
        ...
        public void AppendDescription(StringBuilder text, int maxChildDepth = 10, string separator = "\n")
        {
            ...
            if (maxChildDepth-- > 0 && ChildCount > 0)
            {
                ...
                foreach (var childState in this)
                {
                    ...
                    childState.AppendDescription(text, maxChildDepth, indentedseparator);
                }
            }
        }
