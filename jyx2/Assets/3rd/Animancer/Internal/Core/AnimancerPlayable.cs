...
namespace Animancer
{
        ...
        IEnumerable<AnimancerState>, IEnumerator, IPlayableWrapper, IAnimationClipCollection
    {
        ...
        public override void OnPlayableDestroy(Playable playable)
        {
            ...
            var currentUpdatable = _CurrentUpdatable;
        ...
        public void AppendDescription(StringBuilder text, int maxChildDepth = 7)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                Layers[i].AppendDescription(text, maxChildDepth, separator);
            }
        ...
        private sealed class LateUpdate : PlayableBehaviour
        {
            ...
            {
                var previous = Current;
                var previousLateUpdate = _CurrentLateUpdate;
                ...
                Current = previous;
                _CurrentLateUpdate = previousLateUpdate;
            }
