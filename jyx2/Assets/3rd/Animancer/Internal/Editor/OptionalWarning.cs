...
namespace Animancer
{
    ...
    public enum OptionalWarning
    {
        ...
        /// </remarks>
        MixerSynchroniseZeroLength = 1 << 9,
        ...
        /// </remarks>
        PlayableAssetAnimatorBinding = 1 << 14,
