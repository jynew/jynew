...
::label1::
        Talk(180, "江湖险恶，你们资历尚浅，可要万事小心。");
        Talk(80, "感觉也不险恶嘛，听说罂粟谷是最险恶的地方，但那里的那个阿姨可好了，还送我一个玉镯子，让我凑成了一对。");
        Talk(180, "什么？你说这个玉镯子是罂粟谷的人给你的？");
        Talk(80, "是啊师傅，有什么奇怪吗？");
        Talk(180, "这个，这对玉镯子有一个大秘密！");
        Talk(0, "什么秘密？");
        Talk(180, "这个秘密只有茶恩寺的寿眉大师能够破解，你们可以去请教请教他。");
        ModifyEvent(-2, -2, -2, -2, 85, -1, -1, -2, -2, -2, -2, -2, -2);
        ModifyEvent(3, 6, -2, -2, 0, -1, -1, -2, -2, -2, -2, -2, -2);
do return end;
