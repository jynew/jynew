...
Talk(2, "大师兄把调查师父死因的事全交给我了，我真是毫无头绪。");
Talk(113, "这个傻徒弟，空有一副强壮的身体");
Talk(0, "我觉得你先可以从动机入手，倒着去推理找线索。");
Talk(2, "啥意思？");
Talk(0, "你觉得谁最希望你莫掌门死？");
Talk(2, "那一定是万烛书苑的掌门刘灯剑和钟鸣阁的掌门萨擎苍了。");
Talk(0, "为何这么说呢？");
Talk(2, "这样他们的门派就可以成为渡城第一门派，师父死后，在下个月的比武论英雄活动上，获得四大门派联盟主理人的一定就是他们两个其中的一个。");
Talk(0, "你说会不会是他们陷害了莫掌门呢。");
Talk(2, "小兄弟，你真厉害，你这么一提醒，我真是犹如醍醐灌顶，茅塞顿开。");
