...
::label1::
        ...
        Talk(31, "十六年前，我还不是茶恩寺的住持，我在抵抗蓝隼国入侵的一战中受了重伤，和师傅师兄们走散了。");
        ...
        Talk(0, "四二，别打岔。");
        Talk(31, "后来得知那位女施主有了身孕，我很害怕，我逃回了茶恩寺。");
        Talk(80, "这就是传说中的渣男吗？");
        Talk(0, "你别说话好吗。。。");
        ...
        Talk(31, "那一战茶恩寺损失了很多弟子，后来幸好莫穿林这一代侠士们逐渐成熟了，才能稳住渡城的局势。");
...
::label2::
            ...
            ModifyEvent(-2, 2, -2, -2, 39, -1, -1, -2, -2, -2, -2, -2, -2);
            ModifyEvent(7, 1, -2, -2, 79, -1, -1, -2, -2, -2, -2, -2, -2);
            ModifyEvent(8, 4, -2, -2, 0, -1, -1, -2, -2, -2, -2, -2, -2);
do return end;
