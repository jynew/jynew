Talk(1170, "哎，自从这怡麟楼开了张，我这的生意是越来越惨淡了。");
Talk(0, "你们家的罗大饼不是很有名。");
Talk(1170, "以前客人来了都是连吃五个以上，如今真是门可罗雀，偶尔有人来也就吃一两个，我都打算关门不干了。");
Talk(0, "有没有考虑改进配方和味道呢。");
Talk(1170, "我面试自己揉的，葱是自己种的，现在的人啊，都被怡麟楼的大鱼大肉吃刁了嘴，不喜欢我这传统配方了。");
Talk(0, "那倒也是，饮食行业有竞争才有发展嘛。");
...
::label0::
    ...
    Talk(1170, "二十八个。。。");
    Talk(90, "哈哈，还有吗？");
    Talk(1170, "今天的面粉用完了。。。你这是哪来的小妞，这么生猛。");
