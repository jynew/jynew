...
::label0::
    ...
    jyx2_ReplaceSceneObject("", "NPC/虚竹", "1");--虚竹
    ...
    DarkScence();
    jyx2_ReplaceSceneObject("", "NPC/逍遥子", "1");
	jyx2_FixMapObject("逍遥子传功",1);
	jyx2_SwitchRoleAnimation("NPC/虚竹", "Assets/BuildSource/AnimationControllers/LearnMagic.controller");
    ModifyEvent(-2, 1, 1, 1, -1, -1, -1, 6486, 6486, 6486, -2, -2, -2);
    ModifyEvent(-2, 2, 1, 1, -1, -1, -1, 6450, 6450, 6450, -2, -2, -2);
    Leave(49);
    LightScence();
    ScenceFromTo(17, 28, 24, 19);
	jyx2_CameraFollow("NPC/逍遥子");
	...
	jyx2_SwitchRoleAnimation("NPC/逍遥子", "Assets/BuildSource/AnimationControllers/Dead-FaceUp.controller");
	jyx2_FixMapObject("逍遥子传功完毕",1);
    jyx2_SwitchRoleAnimation("NPC/苏星河", "Assets/BuildSource/AnimationControllers/StandController.controller");
    LightScence();
