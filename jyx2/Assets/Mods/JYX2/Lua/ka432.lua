...
jyx2_ReplaceSceneObject("", "NPC/周伯通", "");--周伯通回到百花谷
jyx2_ReplaceSceneObject("", "NPC/瑛姑", "");--瑛姑回到百花谷
...
jyx2_ReplaceSceneObject("20", "NPC/周伯通", "1");--周伯通回到百花谷
jyx2_ReplaceSceneObject("20", "NPC/瑛姑", "1");--瑛姑回到百花谷
