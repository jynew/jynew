...
Talk(35, "师父，让弟子来即可。", "talkname35", 1);
if TryBattle(34) == true then goto label0 end;
    Dead();
    do return end;
::label0::
    LightScence();
    Talk(35, "承让了，道长。", "talkname35", 1);
...
::label1::
        LightScence();
        Talk(35, "承让了，师太。接下来不知是哪位？", "talkname35", 1);
        Talk(20, "你连战两场，先下去休息吧。", "talkname20", 0);
        Talk(35, "没关系，少年人体力充沛，莫掌门请出手吧。", "talkname35", 1);
...
::label3::
                LightScence();
                Talk(35, "终于都解决了，好累。左冷禅，看来你的阴谋是无法达成了。", "talkname35", 1);
                ...
                Talk(19, "冲儿，你们办完事后，赶紧回来华山。你师娘想你想的紧。", "talkname19", 0);
                Talk(35, "是！", "talkname35", 1);
                DarkScence();
