...
::label0::
    ...
    jyx2_ReplaceSceneObject("", "NPC/韦一笑1", "");--韦一笑进门
    jyx2_ReplaceSceneObject("", "NPC/殷天正1", ""); --殷天正进门
    DarkScence();
	...
	jyx2_ReplaceSceneObject("", "NPC/韦一笑", "1");--韦一笑出现    
	jyx2_ReplaceSceneObject("", "NPC/殷天正", "1"); --殷天正出现
    ModifyEvent(-2, 0, 0, 0, -1, -1, -1, -1, -1, -1, -2, -2, -2);
	jyx2_ReplaceSceneObject("", "Triggers/Leave", "1");--by citydream 显示出口可以离开	
    LightScence();
    ScenceFromTo(29, 48, 29, 35);
	jyx2_CameraFollow("Level/NPC/范瑶");
