Talk(1, "小兄弟，再次造访，是否练就了更高深的武功胡某候教．", "talkname1", 0);
...
::label0::
    ...
    if TryBattle(0) == false then goto label1 end;
        ...
        Talk(1, "住嘴，要不是我所得之刀谱不全，你那接得了我十招．", "talkname1", 0);
        Talk(0, "刀谱不全？你说你使的是不完整的胡家刀法．", "talkname0", 1);
        Talk(1, "是的．等我寻得所失之刀谱咱们俩再较量较量吧！", "talkname1", 0);
        Talk(0, "那胡大哥可知”雪山飞狐”一书之下落．", "talkname0", 1);
        Talk(1, "只因我名字倒过来念之音为飞狐，而且长年居住于东北雪地里，所以江湖上的人送给我一个外号”雪山飞狐”．此外号正好与人人都想争夺的”金氏天书”其中一书名称相同．也正因如此，在这几年间引来了一些武林人士的登门拜访．不过，我胡斐确实不知此书的下落．", "talkname1", 0);
...
::label1::
        ...
        Talk(0, "小弟实在有要找到书的原因并不是大哥所想的贪求武林秘笈的小人．技不如人，我也不再多说，他日再向胡大侠领教胡家刀法．", "talkname0", 1);
