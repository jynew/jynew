Talk(0, "请问一下，你们镳局不做生意了吗？怎么没半个人影．小爷我有些珍贵的宝物还想找你们保呢！", "talkname0", 1);
Talk(36, "这位公子，非常抱歉，今天本镳局不做生意．", "talkname36", 0);
Talk(0, "开了镳局却不做生意，你这”福威镳局”的招牌是挂假的啊！叫你们总镳头出来．", "talkname0", 1);
Talk(36, "说不保镳就不保镳，你在这大呼小叫个什么劲．", "talkname36", 0);
if TryBattle(48) == true then goto label0 end;
    Dead();
    do return end;
::label0::
    LightScence();
    Talk(0, "我看福威镳局的武功也稀松平常，镳还是不要给你们保比较妥当．", "talkname0", 1);
    Talk(36, "哼！要不是我福威镳局被青城派的人大举入侵，家父被抓，家母被杀，其他的镳师死的死，逃的逃，否则．．．．．", "talkname36", 0);
    Talk(0, "这么惨？你们是走失了人家的镳，还是怎么样得罪了青城派．", "talkname0", 1);
