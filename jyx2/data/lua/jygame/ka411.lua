...
Talk(64, "世间我有两个人不见．一位是段皇爷，一位是他的贵妃锳姑．除了这二人之外，我老顽童谁都见得．", "talkname64", 0);
...
Talk(0, "你和锳姑生的孩子啊！", "talkname0", 1);
Talk(64, "什么！我有儿子！．．．．．", "talkname64", 0);
Talk(0, "周老前辈，锳姑如此这般思念你，你始终不肯和他相见，于心何忍？", "talkname0", 1);
...
jyx2_ReplaceSceneObject("", "NPC/zhoubotong", "");--周伯通去黑龙谭找锳姑
LightScence();
Talk(0, "咦，老顽童呢？怎么一溜烟的就不见了，希望是去找锳姑了．", "talkname0", 1);
...
jyx2_ReplaceSceneObject("21", "NPC/zhoubotong", "1");--周伯通去黑龙谭找锳姑
