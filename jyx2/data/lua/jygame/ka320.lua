...
Talk(27, "啊！你便是到梅庄救走任我行的那小子．我早想见你一见，看看是怎样的一位俊俏　郎君．哼，依我看也是平平无奇，比起我那莲弟来，可差的远了．", "talkname27", 0);
...
::label1::
        ...
        Talk(0, "＜原来他是日月神教的前任  教主？＞", "talkname0", 1);
...
::label5::
						...
						jyx2_SwitchRoleAnimation("Level/NPC/dongfangbubai","");--需要改为脸朝天躺地上controller
                        LightScence();
...
::label6::                  Talk(26, "东方不败，今日终于．．．终于教你落在我手里．", "talkname26", 0);
                            ...
                            Talk(0, "＜原来当初任教主以”葵花  宝典”传他，当初便没怀  善意．＞＜两人尔虞我诈各怀心机＞”葵花宝典”一书，不知任教主能否借在下一看．", "talkname0", 1);
