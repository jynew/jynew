...
jyx2_PlayTimeline("[Timeline]ka20_阎基居_中悲酥清风", 1);
DarkScence();
...
jyx2_PlayTimeline("[Timeline]ka20_阎基居_苏醒", 0);
LightScence();
jyx2_Wait(1.5);
...
if TryBattle(1) == false then goto label0 end;
    ...
    Talk(4, "小的这两下那能和少侠相比呢，混口饭吃罢了．对了，小的略通点医术，少侠是否有什么病痛，小的帮你看看．", "talkname4", 0);
