...
::label0::
	...
	jyx2_SwitchRoleAnimation("NPC/xuzhu", "Assets/BuildSource/AnimationControllers/打坐.controller");--需要改为地上打坐controller
	...
	jyx2_SwitchRoleAnimation("NPC/xiaoyaozi", "");--逍遥子死，需要改为脸朝天躺地上controller
