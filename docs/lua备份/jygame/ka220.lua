...
Talk(35, "師父，讓弟子來即可．", "talkname35", 1);
if TryBattle(34) == true then goto label0 end;
    Dead();
    do return end;
::label0::
    LightScence();
    Talk(35, "承讓了，道長．", "talkname35", 1);
...
::label1::
        LightScence();
        Talk(35, "承讓了，師太．接下來不知是那位．", "talkname35", 1);
        Talk(20, "你連戰兩場，先下去休息吧．", "talkname20", 0);
        Talk(35, "沒關係，少年人體力充沛，莫掌門請出手吧．", "talkname35", 1);
...
::label3::
                LightScence();
                Talk(35, "終於都解決了，好累．左冷禪，看來你的陰謀是無法達成了．", "talkname35", 1);
                ...
                Talk(19, "沖兒，你們辦完事後，趕緊回來華山．你師娘想你想的緊．", "talkname19", 0);
